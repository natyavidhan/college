...
## 4. Consider two excel files having attendance of two workshops...
...
0  Alice  2023-01-01          30  2023-01-01          40
1    Bob  2023-01-01          40  2023-01-05          30
2    Bob  2023-01-02          40  2023-01-05          30

Single workshop only:
       Name        Date  duration
2  Charlie  2023-01-01        50
1     Dave  2023-01-03        30
2      Eve  2023-01-04        50
...
[8 rows x 5 columns]
\n*(Note: Plots have been exported/suppressed to maintain readable text output.)*
```
...
print("Age > 30 count:", len(titanic[titanic['age'] > 30]))
print("Second class fare sum:", titanic[titanic['class']=='Second']['fare'].sum())
print("\nSurvivors by class:\n", titanic.groupby('class', observed=False)['survived'].sum())
print("\nAge stats by gender:\n", titanic.groupby('sex')['age'].describe())
print("\nSurvival rate by class (%):\n", titanic.groupby('class', observed=False)['survived'].mean()*100)
```

**Output:**
```text
Age > 30 count: 305
Second class fare sum: 3801.8417
...
print("Gross income:\n", df.groupby('Family')['Income'].sum())
print("\nHighest/Lowest:\n", df.groupby('Family')['Income'].agg(['max','min']))
print("\nIncome < 80k:\n", df[df['Income'] < 80000])
females = df[df['Gender']=='Female']
print("\nFemales count:", len(females), "Avg income:", females['Income'].mean())
avg = df['Income'].mean()
df2 = df[df['Income'] >= avg]
print("\nAbove avg income:\n", df2)
```
...
Females count: 5 Avg income: 111616.0
